...
CREATE TABLE `ubicaciones_tiempo_real` (
  ...
  `latitud` decimal(38,2) NOT NULL,
  `longitud` decimal(38,2) NOT NULL,
  `precision_metros` decimal(10,2) DEFAULT NULL,
  `fecha_registro` datetime DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`id_ubicacion`),
  KEY `id_usuario` (`id_usuario`),
  CONSTRAINT `ubicaciones_tiempo_real_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE

...
CREATE TABLE `postulaciones` (
  ...
  KEY `id_nana` (`id_nana`),
  CONSTRAINT `postulaciones_ibfk_1` FOREIGN KEY (`id_solicitud`) REFERENCES `solicitudes_servicio` (`id_solicitud`) ON DELETE CASCADE,
  CONSTRAINT `postulaciones_ibfk_2` FOREIGN KEY (`id_nana`) REFERENCES `nanas` (`id_nana`) ON DELETE CASCADE
...
-- Dump completed on 2026-07-18 15:46:39
